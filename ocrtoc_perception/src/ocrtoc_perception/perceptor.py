...
class Perceptor():
    ...
    def compute_grasp_poses2(self, full_pcd):
        ...
        # R = full_pcd_d.get_rotation_matrix_from_xyz((np.pi, 0, 0))
        ...
        full_pcd_as_np = np.asarray(grasp_pcd.points) # np.asarray(full_pcd.points)
        full_pcd_colors_as_np = np.asarray(grasp_pcd.colors)*255 # np.asarray(full_pcd.colors)*255
